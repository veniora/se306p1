...
struct R_ID_ {
  ...
  typedef int64_t _Follow_ID_type;
  int64_t Follow_ID;
...
private:
  static const char* __s_getMD5Sum_() { return "25bc6e5c8b7cce4a7c6d38bbbc972924"; }
public:
...
private:
  static const char* __s_getMessageDefinition_() { return "int64 R_State\n\
int64 R_ID\n\
int64 Group_ID\n\
int64 Pos_ID\n\
int64 Follow_ID\n\
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, R_State);
    ...
    ros::serialization::serialize(stream, Follow_ID);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, R_State);
    ...
    ros::serialization::deserialize(stream, Follow_ID);
  ...
  {
    uint32_t size = 0;
    size += ros::serialization::serializationLength(R_State);
    ...
    size += ros::serialization::serializationLength(Follow_ID);
...
struct MD5Sum< ::Project2Sample::R_ID_<ContainerAllocator> > {
  ...
  {
    return "25bc6e5c8b7cce4a7c6d38bbbc972924";
  }

  static const char* value(const  ::Project2Sample::R_ID_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x25bc6e5c8b7cce4aULL;
  static const uint64_t static_value2 = 0x7c6d38bbbc972924ULL;
};
...
struct Printer< ::Project2Sample::R_ID_<ContainerAllocator> >
{
  ...
  {
    s << indent << "R_State: ";
    Printer<int64_t>::stream(s, indent + "  ", v.R_State);
    s << indent << "R_ID: ";
    ...
    s << indent << "Follow_ID: ";
    Printer<int64_t>::stream(s, indent + "  ", v.Follow_ID);
    s << indent << "x: ";
