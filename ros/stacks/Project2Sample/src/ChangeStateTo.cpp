...
/*
 * ChangeToState.cpp
 * This program publishes a single message to the RobotState topic.
...
int main(int argc, char **argv) {
	...
	if (argc != 2) {
		cout
				<< "To run ChangeStateTo use ./ChangeStateTo X, where X is the value of the state to change to.\n";
		cout << "State values: \n";
		cout << "IDLE = 0 \n";
