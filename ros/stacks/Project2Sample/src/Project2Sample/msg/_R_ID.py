...
class R_ID(roslib.message.Message):
  _md5sum = "68ae84a955e4de598c458bb110aab2e5"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2q3d.pack(_x.R_ID, _x.life, _x.x, _x.y, _x.theta))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.R_ID, _x.life, _x.x, _x.y, _x.theta,) = _struct_2q3d.unpack(str[start:end])
      return self
