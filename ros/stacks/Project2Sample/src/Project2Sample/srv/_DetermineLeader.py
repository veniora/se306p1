...
class DetermineLeaderRequest(roslib.message.Message):
  _md5sum = "178f82395769a92289420dcc17fe2f88"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_q3d.pack(_x.R_ID, _x.x, _x.y, _x.theta))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.R_ID, _x.x, _x.y, _x.theta,) = _struct_q3d.unpack(str[start:end])
      return self
...
class DetermineLeader(roslib.message.ServiceDefinition):
  ...
  _md5sum = '5fdc3483f2f0f3279b21a762c35c612f'
